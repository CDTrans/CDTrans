...
for target_dataset in  'painting' 'quickdraw' 'real' 'sketch' 'clipart'
do
    python train.py --config_file configs/uda.yml MODEL.DEVICE_ID $gpus \
    OUTPUT_DIR '../logs/uda/'$model'/domainnet/infograph2'$target_dataset  \
    MODEL.PRETRAIN_PATH '../logs/pretrain/'$model'/domainnet/Infograph/transformer_10.pth' \
